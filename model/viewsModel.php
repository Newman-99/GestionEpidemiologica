...
class viewsModel{
	...
	protected static function getViewModel($requestedView){
					...
					$whileList=["registrar-caso-epidemi","register-user","utilities-other","utilities-color","utilities-border","utilities-animation","tables","register","login","forgot-password","dashboard","charts","cards","buttons","blank","user-list"];
