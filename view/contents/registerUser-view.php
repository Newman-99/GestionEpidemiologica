  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-8 col-lg-12 col-md-12">
       ...
       <span alt="¿La person ya ha sido registrada como paciente o usuario?">¿Persona ya Registrada?<input type="checkbox" name="ifExistPerson" id="ifExistPerson" class="form-control form-control-user" value="1">
        </span>
