            ...
            <div class="p-5">
              <div class="text-center">
                <h1 class="h3 mb-2 text-gray-800">Actualizar Catalogo CIE-10</h1>
                    ...
                    <p class="mb-4">El catalogo CIE-10 que se subira sobreescribira al actual, por lo se debe verificar los datos correctamente y debe asegurarse si este proceso es necesario.</p>
