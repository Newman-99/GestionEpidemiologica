...
<script src="<?php echo SERVERURL; ?>vendor/sheetjs-master/dist/xlsx.full.min.js" type="text/javascript"></script>
<script>
function exportFile(){
...
<?php 
  ...
  <script src="<?php echo SERVERURL; ?>view/js/changeLanguageDatatables.js">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Reportes EPI</h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Vista del Reporte</h6>
