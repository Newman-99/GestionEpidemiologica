...
<tbody>
		...
		<td>1</td>  	
		<td>Colera A00</td>
            <td class='column2 style26 f'>XX</td>
            <td class='column3 style27 f'>XX</td>
            <td class='column4 style26 f'>XX</td>
            <td class='column5 style27 f'>XX</td>
            <td class='column6 style26 f'>XX</td>
            <td class='column7 style27 f'>XX</td>
            <td class='column8 style26 f'>XX</td>
            <td class='column9 style27 f'>XX</td>
            <td class='column10 style26 f'>XX</td>
            <td class='column11 style27 f'>XX</td>
            <td class='column12 style26 f'>XX</td>
            <td class='column13 style27 f'>XX</td>
            <td class='column14 style26 f'>XX</td>
            <td class='column15 style27 f'>XX</td>
            <td class='column16 style26 f'>XX</td>
            <td class='column17 style27 f'>XX</td>
            <td class='column18 style26 f'>XX</td>
            <td class='column19 style27 f'>XX</td>
            <td class='column20 style26 f'>XX</td>
            <td class='column21 style27 f'>XX</td>
            <td class='column22 style26 f'>XX</td>
            <td class='column23 style27 f'>XX</td>
            <td class='column24 style26 f'>XX</td>
            <td class='column25 style27 f'>XX</td>
            <td class='column26 style28 f'>XX</td>
            <td class='column27 style29 f'>XX</td>
            <td class='column28 style30 f'>XX</td>
		</tr>

		<tr>

		<td>2</td>  	
		<td>Diarreas (A08-A08)</td>
            <td class='column2 style31 f'>XX</td>
            <td class='column3 style32 f'>XX</td>
            <td class='column4 style31 f'>XX</td>
            <td class='column5 style32 f'>XX</td>
            <td class='column6 style31 f'>XX</td>
            <td class='column7 style32 f'>XX</td>
            <td class='column8 style31 f'>XX</td>
            <td class='column9 style32 f'>XX</td>
            <td class='column10 style31 f'>XX</td>
            <td class='column11 style32 f'>XX</td>
            <td class='column12 style31 f'>XX</td>
            <td class='column13 style32 f'>XX</td>
            <td class='column14 style31 f'>XX</td>
            <td class='column15 style32 f'>XX</td>
            <td class='column16 style31 f'>XX</td>
            <td class='column17 style32 f'>XX</td>
            <td class='column18 style31 f'>XX</td>
            <td class='column19 style32 f'>XX</td>
            <td class='column20 style31 f'>XX</td>
            <td class='column21 style32 f'>XX</td>
            <td class='column22 style31 f'>XX</td>
            <td class='column23 style32 f'>XX</td>
            <td class='column24 style31 f'>XX</td>
            <td class='column25 style32 f'>XX</td>
...
from '12 epi12, casos_epidemi casos,personas pers 
WHERE casos.catalog_key_cie10 BETWEEN epi12.key_cie10_Inicio AND epi12.key_cie10_final 
AND pers.id_genero = 1  
AND date_part('year',age(casos.fecha_registro, pers.fecha_nacimiento)) < 1
AND pers.doc_identidad = casos.doc_identidad AND pers.id_nacionalidad = casos.id_nacionalidad
AND epi12.orden  = 1 AND casos.fecha_registro BETWEEN '2020-11-03' AND '2020-11-03' LIMIT 1';


$queryGetagrupacion_epi =	'SELECT  orden, enfermedad_evento, key_cie10_Inicio, key_cie10_final 
			FROM '12 LIMIT 3';

	$startRegistrationDate = '2020-10-03';

	$endRegistrationDate = '2020-11-03';


			$rangeAgesStart = [1,1,5];
	...
	try {
		...
		//obtenos la agrupacion y orden del epi
		
		$queryGetagrupacion_epi = $DB_transacc->query($queryGetagrupacion_epi);

		while($agrupacion_epi=$queryGetagrupacion_epi->fetch(PDO
			::FETCH_ASSOC)){ 
			...
			echo $agrupacion_epi['orden'].' . '.$agrupacion_epi["enfermedad_evento"].

				'<br> Genero: '.getInicialGenero($id_genero).'

				<br> Edades: '.$rangeAgesStart[$idAgeRange].' '.$rangeAgesEnd[$idAgeRange] . '

				<br> Nro Casos '.getDataCIE10ForEpi($agrupacion_epi["orden"], $id_genero, $startRegistrationDate, $endRegistrationDate,$DB_transacc,$rangeAgesStart[$idAgeRange],$rangeAgesEnd[$idAgeRange]).'<br><br>';
			}
			...
			$alert=[
				...
				"Text"=>"Informe EPI-12 Realizados",
				"Type"=>"success",
...
function getGenderInitiaContrller($id_genero){
	if ($id_genero == 1) {
		return 'M';
	}else{
...
function getDataCIE10ForEpi($epiOrder, $id_genero, $startRegistrationDate, $endRegistrationDate,$startAge,$ageEnd = ''){
...
if ($ageEnd == 65) {
	...
	$ageRange = "BETWEEN '$startAge' AND '$ageEnd'";	
}
...
from '12 epi12, casos_epidemi casos,personas pers 
WHERE casos.catalog_key_cie10 BETWEEN epi12.key_cie10_Inicio AND epi12.key_cie10_final 
AND pers.id_genero = '$id_genero'
AND date_part('year',age(casos.fecha_registro, pers.fecha_nacimiento)) ".$ageRange."
AND pers.doc_identidad = casos.doc_identidad AND pers.id_nacionalidad = casos.id_nacionalidad
AND epi12.orden  =".$epiOrder." AND casos.fecha_registro BETWEEN '$startRegistrationDate' AND '$endRegistrationDate' LIMIT 1";

		$queryGetDataCIE10ForEPI = $DB->query($queryGetDataCIE10ForEPI);
