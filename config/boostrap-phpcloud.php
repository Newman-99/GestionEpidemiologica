...
// build providers
$filesystems = new Filesystems\FilesystemProvider(Config::fromPhpFile('../config/storage-phpcloud.php'));
...
$databases = new Databases\DatabaseProvider(Config::fromPhpFile('../config/database-phpcloud.php'));
